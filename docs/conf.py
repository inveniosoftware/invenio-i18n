...
latex_documents = [
    (master_doc, "invenio-i18n.tex", "invenio-i18n Documentation", "CERN", "manual"),
]
...
man_pages = [(master_doc, "invenio-i18n", "invenio-i18n Documentation", [author], 1)]
